...
//            }
            ...
            fullTime = new FTE(Integer.parseInt(EN.getText()), FN.getText(), LN.getText(), g, Integer.parseInt(L.getText()), Double.parseDouble(D.getText()), Double.parseDouble(S.getText()), 
                    filename, email1.getText());
           
                        myHashTable.addToTable(fullTime);
            }else{
                PTE partTime = new PTE(Integer.parseInt(EN.getText()), FN.getText(), LN.getText(), g, Integer.parseInt(L.getText()), Double.parseDouble(D.getText()),  Double.parseDouble(w.getText()), Double.parseDouble(h.getText()), Double.parseDouble(weeks.getText()), 
                    filename, email1.getText());
